...
/** WebRTC DataChannel chunk size: 256 KB (smaller MTU than HTTP) */
const WEBRTC_CHUNK_SIZE = 256 * 1024;

/** DataChannel label */
const CHANNEL_LABEL = 'hyperdrop-file';

/** STUN server for LAN ICE candidate gathering */
...
export class WebRTCTransfer {
  ...
  async sendFile(
    ...
    try {
      ...
      this.dc.bufferedAmountLowThreshold = 1024 * 1024; // 1 MB
