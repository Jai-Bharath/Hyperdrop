  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="card flex flex-col items-center gap-1.5 py-4.5 border border-white/5 bg-white/[0.02] min-w-0">
          <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-brand-500/10 text-brand-400">
            <Radio className="h-4.5 w-4.5" />
          </div>
          <span className="font-mono text-xs font-bold text-brand-400 truncate max-w-full px-1.5">
            {serverIp || '—'}
          </span>
          <span className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">
            Server IP
